...
/**
 * /domains/[id]/runs/new — legacy redirect.
 *
 * The chat agent used to mint `cta_url` targeting this path; newer builds
 * point straight at `/runs/new?domain_id=...`. This stub redirects old
...
export default function DomainRunsNewPage() {
  return (
...
function Redirect() {
  ...
  useEffect(() => {
    ...
    if (capId && !next.get("domain_id")) next.set("domain_id", capId);
