    ...
    <Stack gap="4">
      <Stack gap="1">
        ...
        <p className="text-sm text-[var(--text-muted)]">
          Manage WebAuthn passkeys and review the devices currently signed
          in to your account. Changes here apply to your Athena identity
          only; org-level access is governed by Members + SSO.
        </p>
      </Stack>
      <SecurityClient />
    </Stack>
